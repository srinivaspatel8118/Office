...
/*Write a program to define instance methods with return types int, boolean, String and call those methods, store the returned values in corresponding variables in main method 
...
public class Question12 {
	...
	public static void main(String[] args) {
		...
		Question12 ref=new Question12();
				...
				System.out.println("Returned int value i= "+i);
